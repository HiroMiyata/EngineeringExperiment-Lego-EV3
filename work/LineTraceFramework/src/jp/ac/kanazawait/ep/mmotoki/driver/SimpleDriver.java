package jp.ac.kanazawait.ep.mmotoki.driver;

import jp.ac.kanazawait.ep.mmotoki.abst.AbstMotorDriver;

public class SimpleDriver extends AbstMotorDriver {

	final int[] speed = {0, 100, 300, 500, 700};
	 ...
	 */
	public SimpleDriver(String portLeft, String portRight) {
